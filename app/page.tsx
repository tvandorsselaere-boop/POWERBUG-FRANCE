...
const FREE_ACCESSORIES = [
  {
    name: "Porte-boissons NX",
    image: "/images/accessoires/NX-Drink-Holder-Main-min.jpg.webp",
    value: "~30€",
  },
  {
    name: "Support téléphone",
    image: "/images/accessoires/gdm/support-telephone-1.jpg",
    value: "~30€",
  },
];
                ...
                <div className="mt-6">
                  <div className="mb-4 flex items-baseline gap-2">
                    <span className="text-3xl font-bold text-[#0F0F10]">
                      {trolley.price}<span className="text-lg text-[#6B7280]">€</span>
                    </span>
                    {trolley.comparePrice && (
                      <span className="text-sm text-[#6B7280] line-through">{trolley.comparePrice}€</span>
                    )}
              ...
              <div className="flex flex-col items-center gap-8 p-8 sm:p-12 lg:flex-row lg:gap-12">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <h2 className="text-2xl font-bold text-[#0F0F10] sm:text-3xl">
                    2 accessoires offerts (~60€)<br />
                    <span className="text-[#356B0D]">avec chaque chariot</span>
                  </h2>
                  <p className="mt-3 text-sm leading-relaxed text-[#6B7280]">
                    Choisissez vos 2 accessoires préférés parmi notre catalogue lors de la configuration de votre commande. Valeur cumulée jusqu&apos;à 60€ entièrement offerte.
                  </p>
                  <Link
                    href="/configurateur"
