...
import { ShoppingCart, User, LogOut, Package, Settings, ChevronDown, Shield } from "lucide-react";
...
export function Header() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 hidden border-b border-[#DBDBDB] bg-white md:block">
      ...
      {/* Mobile bottom sheet menu — opens from bottom */}
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="bottom" className="rounded-t-2xl border-[#DBDBDB] bg-white px-6 pb-20">
          {/* Logo */}
