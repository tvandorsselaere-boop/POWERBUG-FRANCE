...
/* NOTE: Ces avis sont des placeholders — à remplacer par de vrais avis vérifiés */
const REVIEWS = [
  {
    name: "Jean-Pierre M.",
    date: "Mars 2025",
        ...
        >
          <div className="text-left">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Stars count={5} />
              <span className="text-xs text-[#6B7280]">&mdash; 3 895 avis</span>
            </div>
          </div>
        ...
        >
          <div className="text-left">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Stars count={5} />
              <span className="text-xs text-[#6B7280]">&mdash; 4 415 avis</span>
            </div>
          </div>
          <ExternalLink className="h-4 w-4 shrink-0 text-[#DBDBDB] transition-colors group-hover:text-[#356B0D]" />
        </a>
